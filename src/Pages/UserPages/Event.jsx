              ...
              >
                <div>
                  ...
                  <div className="space-y-3 text-sm text-gray-600">
                    ...
                    <div className="flex items-center gap-2">
                      <Users size={16} /> {parseInt(event.booked)}/
                  ...
                  <div className="mt-6">
                    ...
                    <div className="flex justify-between text-xs text-gray-500 mb-1">
                      ...
                      <span>
                        {Math.max(
                          ...
                          100 -
                            Math.round(
                              (parseInt(event.booked) / event.capacity) * 100,
                            ),
                        )}
                        %
                      </span>
                    ...
                    <div className="w-full h-2 rounded-full bg-gray-200">
                      <div
                        ...
                        style={{
                          width: `${Math.min(100, Math.max(0, 100 - (parseInt(event.booked) / event.capacity) * 100))}%`,
                        }}
                      ></div>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between border-t pt-4 mt-6">
                  ...
                  <button
                    className="bg-green-500 text-white cursor-pointer px-6 py-2 rounded-full text-sm hover:bg-green-600 transition"
                    onClick={() => {
