      ...
      <aside className="w-72 h-screen bg-white  flex flex-col">
        ...
        <div className="p-5 border-b">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 bg-green-500 rounded-2xl flex items-center justify-center text-white font-bold text-xl">
              <Ticket />
            </div>
            <div>
        ...
        <div className="p-5">
          <button
            className="cursor-pointer w-full flex items-center justify-center gap-2 py-3 rounded-full bg-gray-100 text-gray-600 hover:bg-gray-200 transition"
